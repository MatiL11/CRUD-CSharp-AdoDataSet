...
namespace CRUD_DataSet {
    ...
    public partial class MyDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductoDataTable : global::System.Data.TypedTableBase<ProductoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductoRow AddProductoRow(string Nombre, string Marca, decimal Precio) {
...
namespace CRUD_DataSet.MyDataSetTableAdapters {
    ...
    public partial class ProductoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Producto] WHERE (([Id] = @Original_Id) AND ([Nombre] = @Original_Nom" +
                "bre) AND ([Marca] = @Original_Marca) AND ([Precio] = @Original_Precio))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Producto] ([Nombre], [Marca], [Precio]) VALUES (@Nombre, @Marca, @Pr" +
                "ecio);\r\nSELECT Id, Nombre, Marca, Precio FROM Producto WHERE (Id = SCOPE_IDENTIT" +
                "Y())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Producto] SET [Nombre] = @Nombre, [Marca] = @Marca, [Precio] = @Precio WHERE (([Id] = @Original_Id) AND ([Nombre] = @Original_Nombre) AND ([Marca] = @Original_Marca) AND ([Precio] = @Original_Precio));
SELECT Id, Nombre, Marca, Precio FROM Producto WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CRUD_DataSet.Properties.Settings.Default.NegocioConnectionString1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "INSERT INTO Producto(Nombre,Marca,Precio)\r\nVALUES (@Nombre, @Marca, @Precio)";
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Precio", global::System.Data.SqlDbType.Decimal, 9, global::System.Data.ParameterDirection.Input, 10, 2, "Precio", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "UPDATE Producto SET Nombre=@Nombre,Marca=@Marca,Precio=@Precio where Id=@Id";
            ...
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Marca", global::System.Data.SqlDbType.NVarChar, 100, global::System.Data.ParameterDirection.Input, 0, 0, "Marca", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Precio", global::System.Data.SqlDbType.Decimal, 9, global::System.Data.ParameterDirection.Input, 10, 2, "Precio", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._commandCollection[3].CommandText = "SELECT * FROM Producto \r\nWHERE Id=@Id";
            ...
            this._commandCollection[4].CommandText = "DELETE FROM Producto WHERE Id=@Id";
        ...
        public virtual int Fill(MyDataSet.ProductoDataTable dataTable) {
        ...
        public virtual MyDataSet.ProductoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            MyDataSet.ProductoDataTable dataTable = new MyDataSet.ProductoDataTable();
        ...
        public virtual int FillBy(MyDataSet.ProductoDataTable dataTable, int Id) {
        ...
        public virtual MyDataSet.ProductoDataTable GetDataByID(int Id) {
            this.Adapter.SelectCommand = this.CommandCollection[3];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(Id));
            MyDataSet.ProductoDataTable dataTable = new MyDataSet.ProductoDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(MyDataSet.ProductoDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Nombre, string Original_Marca, decimal Original_Precio) {
        ...
        public virtual int Insert(string Nombre, string Marca, decimal Precio) {
            if ((Nombre == null)) {
        ...
        public virtual int Update(string Nombre, string Marca, decimal Precio, int Original_Id, string Original_Nombre, string Original_Marca, decimal Original_Precio, int Id) {
            if ((Nombre == null)) {
                throw new global::System.ArgumentNullException("Nombre");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Marca, decimal Precio, int Original_Id, string Original_Nombre, string Original_Marca, decimal Original_Precio) {
            return this.Update(Nombre, Marca, Precio, Original_Id, Original_Nombre, Original_Marca, Original_Precio, Original_Id);
        }
        ...
        public virtual int Add(string Nombre, string Marca, decimal Precio) {
        ...
        public virtual int Edit(string Nombre, string Marca, decimal Precio, int Id) {
